...
public class Program
{
    ...
    public static void BoxBreathing(int length)
    {
        if (length == 0) length = 4;
        Console.WriteLine($"Inhale for {length} seconds.");
        Console.WriteLine($"Hold breath for {length} seconds.");
        Console.WriteLine($"Exhale for {length} seconds.");
        Console.WriteLine($"Hold breath for {length} seconds.");
        Console.WriteLine($"Inhale for {length} seconds.");
        Console.WriteLine($"Hold breath for {length} seconds.");
        Console.WriteLine($"Exhale for {length} seconds.");
